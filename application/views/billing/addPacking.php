        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Packing</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="ms-panel-body">
                    ...
                    <div class="ms-content-wrapper">
                        ...
                        <div class="row" style="height:inherit;">
                            ...
                            <form class="needs-validation clearfix" novalidate method="post" action="<?php echo base_url('Billing/createPacking') ?>">
                                    ...
                                    <div class="col-md-12  " style="margin-top: 36px;   margin-left: 82px;">
                                        <!--Product type-->
                                        <label style="font-size: 19px;" class="font-weight-bold"> Name</label>
