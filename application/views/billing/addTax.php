                ...
                <div class="ms-panel-body">
                    ...
                    <div class="ms-content-wrapper">
                        ...
                        <div class="row" style="height:inherit;">
                            ...
                            <form class="needs-validation clearfix" novalidate method="post" action="<?php echo base_url('Billing/createTax') ?>">
                                ...
                                <div class="col-md-12 " style="margin-top: 36px;  margin-left: 82px;">
                                    <!--Load Product select-->
                                    <label style="font-size: 19px;" class="font-weight-bold"> Tax % </label>
                                    <div class="form-control contspecvalue4 " style="width: 220px;margin-left: 328px;">
                                        <input type="text" name="tax" class="form-controll">
                                ...
                                <div class="col-md-12 " style="margin-top: 36px;margin-left: 82px;">
                                    ...
                                    <label style="font-size: 19px;" class="font-weight-bold">Cess</label>
                                    <div class="form-control" style="width: 220px;margin-left: 337px;">
                                        <input type="text" name="cess" class="form-controll">
                                    </div>
